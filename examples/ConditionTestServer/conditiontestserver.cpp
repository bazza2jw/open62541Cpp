...
void ConditionServer::initialise() // pre run preparation
{
    ...
    if(!addObjectNode(Open62541::NodeId::Null, Open62541::NodeId::Objects, Open62541::NodeId::Organizes,qn,Open62541::NodeId::BaseObjectType,obj,conditionSource))
    {
    ...
    if(!createCondition<Condition1>(UA_NODEID_NUMERIC(0, UA_NS0ID_OFFNORMALALARMTYPE),"Condition1",conditionSource, conditionInstance_1, Open62541::NodeId::HasComponent))
    {
    ...
    if(!createCondition<Condition2>(UA_NODEID_NUMERIC(0, UA_NS0ID_OFFNORMALALARMTYPE),"Condition2",conditionSource, conditionInstance_2, Open62541::NodeId::HasComponent))
    {
    ...
    //
    addVariable(Open62541::NodeId::Objects,  "Activate Condition 1", Open62541::Variant(false),  variable_1, Open62541::NodeId::Null,&n1);
    addVariable(Open62541::NodeId::Objects,  "Change Severity Condition 2", Open62541::Variant(false),  variable_2, Open62541::NodeId::Null,&n2);
    addVariable(Open62541::NodeId::Objects,  "Return to Normal Condition 1", Open62541::Variant(false),  variable_3, Open62541::NodeId::Null,&n3);
