...
{
public:
    Condition1(Open62541::Server &s, const Open62541::NodeId & c, const Open62541::NodeId &src) :  Condition(s,c,src) {}
...
public:
    Condition2(Open62541::Server &s, const Open62541::NodeId & c, const Open62541::NodeId &src) :  Condition(s,c,src) {}
    virtual bool enteringEnabledState() {
...
public:
    NodeContextV1() : NodeContext("V1") {}
    void setCondition(Open62541::Condition *c) {
        _condition = c;
    }
    virtual void writeValue(Open62541::Server &server, Open62541::NodeId &/*node*/, const UA_NumericRange * /*range*/, const UA_DataValue &data)
    {
        ...
        if(_condition)
        {
            ...
            server.writeObjectProperty_scalar( _condition->condition(),"Time", &data.sourceTimestamp, &UA_TYPES[UA_TYPES_DATETIME]);
...
public:
    ...
    virtual void writeValue(Open62541::Server &server, Open62541::NodeId &/*node*/, const UA_NumericRange * /*range*/, const UA_DataValue &data)
    {
        ...
        if(_condition)
        {
            server.writeObjectProperty_scalar( _condition->condition(),"Severity", (UA_UInt16 *)data.value.data, &UA_TYPES[UA_TYPES_UINT16]);
        }
    }
...
public:
    ...
    virtual void writeValue(Open62541::Server &server, Open62541::NodeId &/*node*/, const UA_NumericRange * /*range*/, const UA_DataValue &data)
    {
        ...
        if(_condition)
        {
            ...
            if(!server.writeObjectProperty_scalar(_condition->condition(),"Time",&data.serverTimestamp, &UA_TYPES[UA_TYPES_DATETIME]))
            {
